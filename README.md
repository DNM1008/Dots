...
copyq, dunst, flameshot, firefox (optional), kitty, (optional), libreoffice (optional),
lxsession, mailspring, mvp, neofetch, nitrogen (optional), nsxiv, nvim, ngvim,
pavucontrol, pcmanfm, picom, pulseaudio, abittorrent, qt5ct, qtile, qtile
extras, rofi, starship, sycthing (optional), zathura.
